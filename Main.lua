...
local Window = Libary:MakeWindow({
    Title = "coca Hub",
    SubTitle = "by:  Developers (não encontrado)",
    LoadText = "coca Developers",
    Flags = "Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://097379863", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({"Aviso! isso e uma copia do chaos hub antigo!"})
