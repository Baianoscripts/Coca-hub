...
local Window = redzlib:MakeWindow({
  Title = "coca hub| Brookhaven 1.0🏡",
  SubTitle = "feito por isne999 e eduardo",
  SaveFolder = "Versão | 1.0"
})
...
Tab1:AddDiscordInvite({
    ...
    Invite = "https://discord.gg/t7NQrUHP",
})

local Section = Tab1:AddSection({"Credits"})

local Paragraph = Tab1:AddParagraph({"Criador", "isne999 e eduardo"})
