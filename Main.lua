loadstring(game:HttpGet("https://raw.githubusercontent.com/Baianoscripts/Redz-lib-fire-hub/refs/heads/main/Main.lua"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "coca hub",
    SubTitle = "by:  Developers (blox_doido_23968)",
    LoadText = "coca Developers",
    Flags = "Broookhaven"
})
...
InfoTab:AddParagraph({ "Você está usando:", "coca  Hub" })
InfoTab:AddParagraph({"Novidades:", "+4 áudios novos na tab Audio All! (adicionado por frost)"})
